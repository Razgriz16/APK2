...
@Composable
fun MovimientosListLcc(movimientos: List<MovimientosLcc>) {
    LazyColumn(
        ...
        items(movimientos) { movimiento ->
            MovimientoItemLcc(movimiento = movimiento)
...
@Composable
fun MovimientoItemLcc(movimiento: MovimientosLcc) {
    var showDialog by remember { mutableStateOf(false) }

    if (showDialog) {
        DialogMovimientosLcc(movimiento = movimiento) {
            showDialog = false
        }
    }
...
@Composable
fun DialogMovimientosLcc(
    movimiento: MovimientosLcc,
    onDismiss: () -> Unit
) {
    AlertDialog(
        ...
        text = {
            ...
            Column {
                DetailRow(label = "Transacción:", value = movimiento.TIPOMOVIMIENTO)
