...
fun MovimientoItem(movimiento: Movimiento) {
    ...
    if (showDialog) {
        DialogMovimientos(movimiento = movimiento) {
            showDialog = false
        }
    }
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = movimiento.FECHAPAGO, // Removed "Fecha: "
    ...
    AlertDialog(
        ...
        text = {
            ...
            Column {
                ...
                //DetailRow(label = "Sucursal:", value = movimiento.)
                DetailRow(
                    label = "Monto:",
                    value = if (movimiento.ESCARGO == "N")
                        "+$${movimiento.MONTO}"
                    else
                        "-$${movimiento.MONTO}",
