...
import com.example.oriencoop_score.view.mis_productos.cuenta_csocial.CuentaCsocial
...
fun Navigation() {
    ...
    NavHost(navController = navController, startDestination = Pantalla.Login.route) {
        ...
        composable(route = Pantalla.CuentaCsocial.route) {

            CuentaCsocial(navController = navController) /*, viewModel = harryPotterViewModel*/
        }
